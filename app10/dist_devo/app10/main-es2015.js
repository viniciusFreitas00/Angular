...
let PainelComponent = class PainelComponent {
    constructor() {
        ...
        this.progresso = 0;
        this.tentativas = 3;
        this.encerrarJogo = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"](); /* @Output faz o data Binding entre o component filho e o component pai de maneira semelhante ao @Input
...
class Coracao {
    constructor(cheio, urlCheio = '/assets/coracao_cheio.png', urlVazio = '/assets/coracao_vazio.png') {
        this.cheio = cheio;
...
module.exports = __webpack_require__(/*! C:\Users\ecasarotte\Angular_teste\projetosAngularTeste\app10\src\main.ts */"./src/main.ts");
